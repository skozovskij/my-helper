        ...
        contentBlocks: [
          {
            ...
            questions: [
              {
                question: "Що вивчає органічна хімія?",
                options: [
                  "Сполуки Нітрогену",
                  "Сполуки Карбону",
                  "Сполуки Оксигену",
                ...
                correctAnswerIndex: 1 // "Сполуки Карбону"
              },
              {
                question: "Яку валентність ЗАВЖДИ має Карбон в органічних сполуках?",
                options: [
                  "Два (II)",
                  "Три (III)",
                  "Чотири (IV)",
                  "Залежить від сполуки"
                ],
                correctAnswerIndex: 2 // "Чотири (IV)"
              },
              {
                question: "Що таке ізомери?",
                options: [
                  "Речовини з різним складом, але однаковою будовою",
                  "Речовини з однаковим складом, але різною будовою",
                  "Речовини, що не реагують",
                  "Інша назва циклічних систем"
                ],
                correctAnswerIndex: 1 // "Речовини з однаковим складом, але різною будовою"
              },
              {
                question: "Що таке цис-ізомер?",
                options: [
                  "Однакові групи по різні боки зв'язку С=С",
                  "Молекули з асиметричним атомом Карбону",
                  "Однакові групи по один бік зв'язку С=С",
                  "Інша назва оптичної ізомерії"
                ],
                correctAnswerIndex: 2 // "Однакові групи по один бік зв'язку С=С"
              }
            ]
          }
        ]
        ...
        contentBlocks: [
          {
            ...
            questions: [
              ...
              {
                question: "В якому стані sp-гібридизації перебувають атоми Карбону в молекулах алканів?",
                options: [
                  "$sp$",
                  "$sp^2$",
                  "$sp^3$",
              ...
              {
                question: "Алкани, що мають від 5 до 15 атомів Карбону (C₅–C₁₅), за звичайних умов є:",
                options: [
                  "Газами",
                  "Рідинами",
                  "Твердими речовинами",
              ...
              {
                question: "Який тип реакцій є найбільш характерним для алканів через їх насичену будову?",
                options: [
                  "Приєднання",
              ...
              {
                question: "Яку загальну формулу мають циклоалкани (з одним циклом)?",
                options: [
                  "$C_nH_{2n+2}$",
                  "$C_nH_{2n}$",
                  "$C_nH_{2n-2}$",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Яка загальна формула гомологічного ряду алкенів?",
                "options": [
                  "$C_nH_{2n}$",
                  "$C_nH_{2n+2}$",
                  "$C_nH_{2n-2}$",
              ...
              {
                "question": "Яка загальна формула гомологічного ряду алкінів?",
                "options": [
                  "$C_nH_{2n}$",
                  "$C_nH_{2n+2}$",
                  "$C_nH_{2n-2}$",
              ...
              {
                "question": "Який тип гібридизації мають атоми Карбону при подвійному зв'язку (C=C) в алкенах?",
                "options": [
                  "$sp$",
                  "$sp^2$",
                  "$sp^3$",
              ...
              {
                "question": "Який тип гібридизації мають атоми Карбону при потрійному зв'язку (C≡C) в алкінах?",
                "options": [
                  "$sp$",
                  "$sp^2$",
                  "$sp^3$",
              ...
              {
                "question": "Який клас сполук має ту саму загальну формулу ($C_nH_{2n-2}$), що й алкіни?",
                "options": [
                  "Алкани",
                  "Арени",
                  "Алкадієни",
              ...
              {
                "question": "Що утворюється в результаті реакції гідратації (приєднання води) алкенів?",
                "options": [
                  "Алкани",
                  "Спирти",
                  "Альдегіди",
              ...
              {
                "question": "Як називається реакція гідрування алкенів?",
                "options": [
                  "Приєднання води",
                  "Приєднання водню",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Яка загальна формула гомологічного ряду аренів (з одним бензеновим кільцем)?",
                "options": [
                  "$C_nH_{2n+2}$",
                  "$C_nH_{2n}$",
                  "$C_nH_{2n-6}$",
              ...
              {
                "question": "Згідно з правилом Хюккеля, скільки $\\pi$-електронів повинна мати ароматична система?",
                "options": [
                  "$4n$ π-електронів",
                  "$4n+2$ π-електронів",
                  "$4n+1$ π-електронів",
                  "Будь-яку парну кількість"
                ],
                "correctAnswerIndex": 1
              },
              {
                "question": "Який тип реакцій є найбільш характерним для бензену?",
                "options": [
              ...
              {
                "question": "Чим толуен (метилбензен) хімічно відрізняється від бензену?",
                "options": [
                  "Бензен легше окиснюється",
                  "Толуен легше окиснюється",
                  "Бензен вступає в реакції приєднання, а толуен ні",
                  "Толуен не вступає в реакції нітрування"
                ],
                "correctAnswerIndex": 1
              },
              {
                "question": "Яка фізична властивість НЕ характерна для бензену?",
                "options": [
                  "Безбарвна рідина",
                  "Токсичний",
                  "Має різкий запах",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Яка загальна формула насичених одноатомних спиртів?",
                "options": [
                  "$C_nH_{2n}OH$",
                  "$C_nH_{2n+1}OH$",
                  "$C_nH_{2n-1}OH$",
              ...
              {
                "question": "Яка функціональна група визначає клас спиртів?",
                "options": [
                  "$-COOH$ (Карбоксильна)",
                  "$-CHO$ (Альдегідна)",
                  "$-OH$ (Гідроксильна)",
              ...
              {
                "question": "До якого типу спиртів належить гліцерин?",
                "options": [
                  "Одноатомних",
                  "Багатоатомних",
                  "Ароматичних (Фенолів)",
              ...
              {
                "question": "Як називається процес добування етанолу з глюкози ($C_6H_{12}O_6$)?",
                "options": [
                  "Гідратація",
                  "Гідроліз",
                  "Естерифікація",
              ...
              {
                "question": "Що утворюється при окисненні первинних спиртів?",
                "options": [
                  "Альдегіди",
                  "Кетони",
                  "Алкени",
              ...
              {
                "question": "Чим феноли відрізняються від спиртів?",
                "options": [
                  "Мають дві $-OH$ групи",
                  "Група $-OH$ приєднана до бензенового кільця",
                  "Не реагують з металами",
                  "Є газами за н.у."
                ],
                "correctAnswerIndex": 1
              },
              {
                "question": "Який багатоатомний спирт є солодким на смак, неотруйним та гігроскопічним?",
                "options": [
                  "Метанол",
                  "Етиленгліколь",
                  "Гліцерин",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Найменша частинка речовини, здатна існувати самостійно та зберігати її властивості - це...",
                "options": [
                  "Атом",
                  "Іон",
                  "Молекула",
              ...
              {
                "question": "Від чого, згідно з Періодичним законом, періодично залежать властивості хімічних елементів?",
                "options": [
                  "Від атомної маси",
                  "Від кількості нейтронів",
              ...
              {
                "question": "Що в періодичній системі відповідає числу енергетичних рівнів в атомі?",
                "options": [
                  "Номер групи",
                  "Номер періоду",
                  "Порядковий номер",
              ...
              {
                "question": "Що в періодичній системі (для головних підгруп) відповідає кількості валентних електронів?",
                "options": [
                  "Номер групи",
                  "Номер періоду",
                  "Протонне число",
              ...
              {
                "question": "Атоми одного елемента з різною масою (різною кількістю нейтронів) називаються...",
                "options": [
                  "Ізобари",
                  "Ізотопи",
                  "Іони",
              ...
              {
                "question": "В електронейтральному атомі порядковий номер дорівнює кількості протонів та...",
                "options": [
                  "Кількості нейтронів",
                  "Нуклонному числу",
              ...
              {
                "question": "Які частинки в атомі не змінюються під час хімічних реакцій?",
                "options": [
                  "Електрони на зовнішньому рівні",
                  "Тільки протони",
                  "Ядро (протони і нейтрони)",
                  "Всі електрони"
                ],
                "correctAnswerIndex": 2
              }
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Який тип зв'язку утворюється завдяки спільним електронним парам між атомами?",
                "options": [
                  "Іонний",
                  "Металічний",
                  "Ковалентний",
              ...
              {
                "question": "Який тип ковалентного зв'язку існує в молекулі H₂ (атоми з однаковою електронегативністю)?",
                "options": [
                  "Полярний",
                  "Неполярний",
                  "Іонний",
              ...
              {
                "question": "Який тип зв'язку утворюється між іонами K⁺ та Cl⁻ в кристалі KCl?",
                "options": [
              ...
              {
                "question": "Який механізм утворення зв'язку, коли один атом надає електронну пару, а інший - вільну орбіталь (наприклад, в NH₄⁺)?",
                "options": [
                  "Обмінний",
                  "Донорно-акцепторний",
                  "Іонний",
              ...
              {
                "question": "Який тип зв'язку пояснює електропровідність, ковкість і металічний блиск металів?",
                "options": [
                  "Металічний",
                  "Іонний",
                  "Водневий",
              ...
              {
                "question": "Який слабкий зв'язок виникає між молекулами води (H₂O) і пояснює, чому вона є рідиною?",
                "options": [
                  "Іонний",
                  "Водневий",
                  "Металічний",
              ...
              {
                "question": "Речовини (наприклад, I₂ або H₂O) з низькими температурами плавлення та кипіння, що складаються з окремих молекул, мають...?",
                "options": [
                  "Молекулярну будову",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Яка з цих реакцій є реакцією сполучення?",
                "options": [
                  "$CaCO_3 \\rightarrow CaO + CO_2$",
                  "$2Mg + O_2 \\rightarrow 2MgO$",
                  "$FeS + 2HCl \\rightarrow FeCl_2 + H_2S\\uparrow$",
                  "$C(графіт) \\rightarrow C(алмаз)$"
                ],
                "correctAnswerIndex": 1
              },
              {
                "question": "Реакції, що відбуваються з виділенням теплоти (наприклад, горіння), називаються...",
                "options": [
                  "Ендотермічними",
                  "Екзотермічними",
                  "Гомогенними",
              ...
              {
                "question": "Реакції, що протікають одночасно в прямому і зворотному напрямках (наприклад, $3H_2 + N_2 \\leftrightarrow 2NH_3$), називаються...",
                "options": [
                  "Необоротними",
                  "Оборотними",
                  "Заміщення",
              ...
              {
                "question": "Відповідно до правила Вант-Гоффа, при збільшенні температури на 10°C, швидкість реакції...",
                "options": [
              ...
              {
                "question": "Як називається стан, коли швидкість прямої реакції дорівнює швидкості зворотної?",
                "options": [
                  "Хімічна рівновага",
              ...
              {
                "question": "Яка з умов НЕ є обов'язковою для протікання реакції обміну до кінця (згідно з правилом Бертолле)?",
                "options": [
                  "Утворення осаду",
                  "Виділення газу",
                  "Утворення води (слабкого електроліту)",
                  "Виділення тепла"
                ],
                "correctAnswerIndex": 3
              },
              {
                "question": "Реакція, що відбувається в однорідному середовищі (наприклад, між двома газами), називається...",
                "options": [
                  "Гетерогенною",
                  "Ендотермічною",
                  "Гомогенною",
        ...
        "contentBlocks": [
          {
            ...
            "questions": [
              {
                "question": "Розчин - це дисперсна система, що складається з дисперсійного середовища (розчинника) та...",
                "options": [
                  "Дисперсної фази (розчиненої речовини)",
                  "Іншого розчинника",
                  "Кристалогідрату",
                  "Осаду"
                ],
              ...
              {
                "question": "Який тип розчину демонструє ефект Тіндаля (розсіювання світла)?",
                "options": [
                  "Справжній розчин",
                  "Суспензія",
                  "Колоїдний розчин",
              ...
              {
                "question": "Розчин, що містить максимальну кількість розчиненої речовини при даній температурі, називається...",
                "options": [
                  "Ненасиченим",
                  "Пересиченим",
                  "Насиченим",
              ...
              {
                "question": "Згідно з принципом \"подібне розчиняється в подібному\", неполярні речовини (наприклад, олія) будуть добре розчинятися у...",
                "options": [
                  "Воді (полярний)",
                  "Спирті (полярний)",
                  "Бензені (неполярний)",
              ...
              {
                "question": "Як називаються речовини, що кристалізуються з водою, наприклад, $CuSO_4 \\cdot 5H_2O$?",
                "options": [
                  "Гідроксиди",
                  "Оксиди",
                  "Кристалогідрати",
              ...
              {
                "question": "Як зазвичай змінюється розчинність більшості твердих речовин у воді при підвищенні температури?",
                "options": [
                  "Зменшується",
                  "Збільшується",
                  "Не змінюється",
              ...
              {
                "question": "Масова частка (ω) розчиненої речовини обчислюється за формулою...",
                "options": [
                  "$m(речовини) / V(розчину)$",
                  "$n(речовини) / V(розчину)$",
                  "$m(речовини) / m(розчину)$",
                  "$m(розчинника) / m(розчину)$"
                ],
                "correctAnswerIndex": 2
              },
              {
                "question": "Молярна концентрація (Cм) вимірюється в яких одиницях?",
                "options": [
                  "г/л",
                  "%",
                  "моль/л",
